...
//        var_dump($student);
//        var_dump((new StudentSeatModel())->takeSeat('1',1));
//        var_dump((new StudentSeatModel())->takeSeat('1',2));
//        var_dump((new StudentSeatModel())->takeSeat('2',1));
        var_dump((new StudentSeatModel())->takeSeat('1',1));
//        var_dump((new StudentModel())->addScore('1','1'));
//        var_dump((new StudentModel())->decScore('1','1'));
//        var_dump($seat);
//        var_dump($seatType);
